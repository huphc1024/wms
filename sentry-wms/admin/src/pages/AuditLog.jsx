...
// Top-level tab switch. The Audit Log page historically opened on the
// full audit feed; Item History is the default tab so a supervisor
...
function AuditTable({
  logs, pagination, onPageChange, onRowClick,
